        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                if (tempString.contains("</dimen>")) {
                    ...
                    sw240.append(start).append((int) (num * 0.75)).append(end).append("\r\n");

                    sw300.append(start).append((int) (num * 0.93)).append(end).append("\r\n");

                    sw360.append(start).append((int) (num * 1.125)).append(end).append("\r\n");

                    sw480.append(start).append((int) (num * 1.5)).append(end).append("\r\n");

                    sw600.append(start).append((int) (num * 1.87)).append(end).append("\r\n");

                    sw720.append(start).append((int) (num * 2.25)).append(end).append("\r\n");

                    sw800.append(start).append((int) (num * 2.5)).append(end).append("\r\n");

//                    w820.append(start).append((int)(num * 2.56)).append(end).append("\r\n");
