...
//        column_chart.setViewportCalculationEnabled(false);
...
//                    loadData(column_chart, 10);
    ...
    private void loadData(final ColumnChartView mChart, final int columnCount) {
...
//        mYLeft.setAutoGenerated(true);
        ...
        column_chart.setMaximumViewport(v);
        v.left = columnCount;
        v.right = columnCount + 9;
        column_chart.setCurrentViewport(v);
//        column_chart.setViewportCalculationEnabled(false);

        column_chart.scrollTo(column_chart.getLeft(), 0);
...
//                if (viewport.left <= (0.0) && mCount == 0) {
//                    mCount++;
//                Log.e("TAG", "left : " + viewport.left + "right : " + viewport.right);
                Log.e("TAG", "right - left : " + Math.ceil(viewport.right - viewport.left));
                Log.e("TAG", "viewport.centerX() : " + Math.ceil(viewport.centerX()));
//                Toast.makeText(HelloChartsActivity.this, "left ", Toast.LENGTH_SHORT).show();
//                    loadData(column_chart, 10);
//                load(column_chart);
//                }
...
//        column_chart.setOnValueTouchListener(new ColumnChartOnValueSelectListener() {
//            @Override
//            public void onValueSelected(int columnIndex, int subcolumnIndex, SubcolumnValue value) {
//                Viewport v = mChart.getMaximumViewport();
//                if (columnIndex == (int) v.centerX()) {
