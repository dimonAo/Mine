...
public abstract class ScrollPickerView<T> extends View {
    ...
    private int mVisibleItemCount; // 可见的item数量
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.e(TAG,"centerPosition : "+mCenterPosition+" mVisibleItemCount : "+mVisibleItemCount);
...
//        if (mCenterPosition < 0) {
            mCenterPosition = (this.mVisibleItemCount / 2);
//        }
...
//        invalidate();
    ...
    public void setCenterPosition(int centerPosition) {
        ...
        mCenterY = mCenterPosition * mItemHeight;
//        mCenterY = mCenterPosition * mItemSize;
        invalidate();
    }
